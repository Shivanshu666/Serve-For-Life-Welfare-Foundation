...
//   const countdownItems: string[] = ["Days", "Hours", "Minutes", "Seconds"];
...
//       {/* Single Card - height 80vh */}
//       <motion.div
//         initial="hidden"
//         animate="visible"
//         variants={fadeUp}
//         className="relative z-10 w-full max-w-3xl h-[80vh] rounded-3xl bg-white/70 backdrop-blur-sm border border-slate-200 shadow-xl shadow-emerald-100/40 flex flex-col items-center justify-center p-8 text-center overflow-y-auto"
//       >
...
//         {/* Newsletter */}
//         <div className="mt-4 p-6 rounded-2xl bg-white/70 backdrop-blur-sm border border-slate-200 shadow-lg shadow-emerald-100/40 inline-block w-full max-w-md">
...
//             />
//             <button className="px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold hover:scale-105 transition duration-300 shadow-lg shadow-emerald-200">
//               Notify Me
//             </button>
//           </div>
//         </div>
