  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F8FAF7] via-white to-[#EEF7F2] text-slate-900 flex items-center justify-center px-6 py-32 overflow-hidden relative">
      ...
      >
        ...
        {/* 45vh Card */}
        <div className="mt-10 w-full h-[45vh] rounded-3xl bg-white/70 backdrop-blur-sm border border-slate-200 shadow-xl shadow-emerald-100/40 flex flex-col items-center justify-center p-8">
